  ...
  return (
    ...
    >
      ...
      <div className="mt-auto relative z-10">
        <div className="absolute top-0 left-4 right-4 h-px bg-gradient-to-r from-transparent via-gray-200/50 to-transparent"></div>
        
        <div className={`p-3 transition-all duration-500 ${isOpen ? "mx-1" : ""}`}>
          <button
            className={`group relative flex items-center ${
              isOpen ? "px-4 py-3.5" : "justify-center p-3 mx-auto w-12 h-12"
            } rounded-2xl cursor-pointer transition-all duration-400 hover:bg-white/50 hover:shadow-[inset_0_1px_2px_rgba(255,255,255,0.5)] border border-transparent hover:border-white/40 w-full outline-none`}
          >
